declare namespace TcHmi.BuildingAutomation.Controls.Common {
    ...
    class TabWindow extends System.BaseControl {
         ...
         */
        setData(p: TabWindow.ITabDataDesigner[] | null | undefined): this;
        /**
         ...
         */
        getData(): TabWindow.ITabDataDesigner[] | null;
        /**
    ...
    namespace TabWindow {
        /**
         * Data of a Tab defined in the designer.
         */
        interface ITabDataDesigner {
        ...
        /**
         * Validates the interface 'ITabDataDesigner'.
         * @param p The input that should be checked.
         * @returns True if the input is valid and false if not.
        */
        function isTabData(p: object | null | undefined): p is ITabDataDesigner;
    }
}
