declare namespace TcHmi.BuildingAutomation.Controls.Common {
    ...
    class UiIcon extends Button implements BaObjectHandler.IFCUsesBaObject {
         ...
         */
        addDisplay(name: string, data: Components.UiIcon.IDisplayData): Components.ValueField<Components.ValueField.ValueType>;
        /**
         ...
         */
        getDisplay(name: string): Components.ValueField<Components.ValueField.ValueType> | null;
        /**
        * Get all created displays.
        * @category Public
        * @returns All created displays.
        */
        getDisplays(): Map<string, Components.ValueField<Components.ValueField.ValueType>> | undefined;
        /**
