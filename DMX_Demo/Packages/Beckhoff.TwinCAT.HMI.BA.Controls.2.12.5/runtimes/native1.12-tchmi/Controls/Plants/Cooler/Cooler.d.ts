declare namespace TcHmi.BuildingAutomation.Controls.Plants {
    ...
    */
    class Cooler<T extends Cooler.BaTemplateDefinition> extends System.BaseTemplate<T> {
        ...
        onResized(): void;
        /** @ignore
        * Determine the visibility of __flowTempSensor.
        * @category Internal
        */
        protected __determineVisibilityFlowTempSensor(): void;
        /** @ignore
        * Determine the visibility of __returnTempSensor.
        * @category Internal
        */
        protected __determineVisibilityReturnTempSensor(): void;
        /** @ignore
        * Determine the visibility of __valve.
        * @category Internal
        */
        protected __determineVisibilityValve(): void;
        /**
