declare namespace TcHmi.BuildingAutomation.Controls.Plants {
    ...
    class ErcPlate<T extends ErcPlate.BaTemplateDefinition> extends Controls.System.BaseTemplate<T> {
        ...
        destroy(): void;
        /** @ignore
        * Determine the visibility of __diffPrssSwi.
        * @category Internal
        */
        protected __determineVisibilityDiffPrssSwi(): void;
        /** @ignore
        * Determine the visibility of __damper.
        * @category Internal
        */
        protected __determineVisibilityDamper(): void;
        /** @ignore
        * Determine the visibility of __damperBy.
        * @category Internal
        */
        protected __determineVisibilityDamperBy(): void;
        /**
