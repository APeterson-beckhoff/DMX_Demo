declare namespace TcHmi.BuildingAutomation.Controls.Plants {
    ...
    class PreHeater<T extends PreHeater.BaTemplateDefinition> extends HeatingCircuit<T> {
        ...
        onResized(): void;
        /** @ignore
        * Determine the visibility of __frostThermostat.
        * @category Internal
        */
        protected __determineVisibilityFrostThermostat(): void;
        /** @ignore
        * Determine the visibility of __tFrost.
        * @category Internal
        */
        protected __determineVisibilityTFrost(): void;
        /**
        * Sets setpoint.
