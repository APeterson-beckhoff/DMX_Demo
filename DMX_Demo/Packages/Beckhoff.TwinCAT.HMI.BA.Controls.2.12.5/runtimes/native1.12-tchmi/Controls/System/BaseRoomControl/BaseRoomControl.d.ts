declare namespace TcHmi.BuildingAutomation.Controls.System {
    ...
    class BaseRoomControl<I extends BaseRoomControl.BaInterface> extends System.TextControl implements BaInterfaceHandler.IUsesBaInterface<I>, BaObjectHandler.IUsesBaObject {
        ...
        private __errorLegendIconHandler;
        ...
        /**
         * Depending on available elements in the linked BaInterface of BaObject the control can be controllable or not.
         * @param isControllable Defines if the control is controllable.
         */
        ...
        setShowPriority(p: boolean | null | undefined): this;
        /**
         * Processor for the ShowPriority attribute.
         * @category Attribute setter and getter
         */
        protected __processShowPriority(): void;
        /**
         * Getter for the ShowPriority attribute.
         * @category Attribute setter and getter
         * @returns The ShowPriority attribute.
         */
        getShowPriority(): boolean | null | undefined;
    ...
    namespace BaseRoomControl {
        interface IAttributes extends System.TextControl.IAttributes {
            ...
            /** Defines if the priority is displayed. */
