declare namespace TcHmi.BuildingAutomation.BA {
    ...
    class BaBasicObject<P extends BaInterfaceHandler.IBaInterfaceStructure = any> implements Logger.ILogger, Navigation.INodeData {
         ...
         * @returns The DestroyFunction for the created watch.
         */
        watchProperty<T>(name: string, callback: (data: T | null | undefined) => void): DestroyFunction;
        /**
         * Stops a specified watch of a property.
         * @param name The name of the property.
         * @param id The id of the watch.
         */
        private __stopWatchProperty;
        /**
         * Stops all watches of a certain property.
         * @param name Name of the property for which all watches shall be stopped.
         */
        private __stopAllWatchesProperty;
        /**
         ...
         * @param id Id of the BaVariable.
         * @param callback Callback is called if the value of the variable has changed.
         * @returns The DestroyFunction of the created watch to destroy the watch later and undefined if the BaObject does not contain this Variable.
         */
        tryWatchBaVariable<T>(id: BaParameterId, callback: (data: T | null | undefined) => void): DestroyFunction | undefined;
        tryWatchBaVariable<K extends keyof P>(id: K, callback: (data: P[K] | null | undefined) => void): DestroyFunction | undefined;
        /**
     ...
     */
    class BaEventEnabledObjectHandling implements Logger.ILogger {
        /**
         * Handles the events of an event enabled {@link BaBasicObject}.
        ...
        protected __watchEventsPerIconCallbacks: Map<number, ((data: Map<EventCondition, EventsPerIconImage>) => any)>;
         ...
         * @returns The DestroyFunction for the created watch.
         */
        watchEventsPerIcon(cb: (data: Map<EventCondition, EventsPerIconImage>) => any): DestroyFunction;
        /**
         * Stops a specified watch of the events.
         * @param id The id of the watch.
         */
        protected __stopWatchEventsPerIcon(id: number): void;
        /**
...
declare namespace TcHmi.BuildingAutomation.BA {
    ...
    class BaEvent implements BaEvent.IBaEvent, Logger.ILogger {
        ...
        /**
         * DestroyFunction for watching the events of the BaObject.
         * @category Internal
         */
        private __eventSubscriptionDF;
         ...
         * @returns The DestroyFunction for the created watch.
         */
        watch(callback: (data?: BaEvent.IBaEvent) => void): DestroyFunction;
        /**
         * Stops watching of all events.
         */
        stopAllEventWatches(): void;
        /**
    ...
    namespace EventHelper {
         ...
         */
        function invokeEventCallbacks(events: Map<EventCondition, EventsPerIconImage> | undefined, cbs: Map<number, ((data: Map<EventCondition, EventsPerIconImage>) => any)>): void;
    }
}
...
declare namespace TcHmi.BuildingAutomation {
    class BaObjectHandler implements IDestroy {
        ...
        /**
         * Stores all {@link DestroyFunction}s for watches of BaVariables that have been created with this instance.
         * @category Internal
         */
        private __baVarWatchDFs;
        /**
         * Stores {@link DestroyFunction}s for children of BaObject.
         * @category Internal
         */
        private __baChildrenDFs;
        /**
         * Stores {@link DestroyFunction}s for value range watches.
         * @category Internal
         */
        private __baWatchValueRangeDFs;
        /**
         * DESCRIPTION
         * @category Internal
         */
        ...
        /**
         * {@link DestroyFunction} for the onDevcieConnectionStateChanged event of the device.
         * @category Internal
         */
         ...
         * @returns The DestroyFunction for the registered watch.
         */
        watchBaVariable<T>(baVar: BA.BaVariable<T>, callback: (data: T | null | undefined) => void, setBusy?: boolean): DestroyFunction;
        /**
         * Try watching a BaVariable.
         * @category Public
         ...
         * @param callback Callback is called if the value of the variable has changed.
         * @param setBusy (Default true) If true the control will be set to busy when the variable is read the first time.
         * @returns Returns DestroyFunction if the watch was registered, otherwise undefined.
         */
        tryWatchBaVariable<T>(baVarId: BA.BaParameterId, callback: (data: T | null | undefined) => void, setBusy?: boolean): DestroyFunction | undefined;
        /**
         ...
         */
        tryWatchChildrenBaVariable<T>(child: BA.BaBasicObject | null | undefined, baVarId: BA.BaParameterId, callback: (data: T | null | undefined) => any, setBusy?: boolean): DestroyFunction | undefined;
        /**
         ...
         */
        watchValueRange(baVarId: BA.BaVariable | BA.BaParameterId, callback: (data: BA.BaVariable.ValueRange | undefined) => void, setBusy?: boolean): DestroyFunction | undefined;
        /**
         * Stops all watches.
         * @category Public
         */
...
declare namespace TcHmi.BuildingAutomation.BA {
    ...
    class BaVariable<T = any> implements Navigation.INodeData, Logger.ILogger {
        ...
        editedValue?: T;
        /** DestroyFunction if a subscription for the BaVariable was created. */
        private __subscriptionDF;
        ...
        /**
         * Options of the BaVariable.
         * @category Property
         */
        get Options(): BaVariable.IOptions | undefined;
        /**
         ...
         * @category Public
         * @param callback Callback is called if the value of the variable has changed.
         * @returns The DestroyFunction for the created watch. This id is needed to destroy this watch.
         */
        watch(callback: (data: T | null | undefined) => void): DestroyFunction;
        /**
    ...
    namespace BaVariable {
        ...
        */
        ...
        interface IOptions {
            /** Options to edit the appearance of the BaVariable if displayed. */
            appearance?: {
                /** Number of digits to be displayed, when the value is displayed. */
                digits?: number | null;
            };
        }
        /**
         * Options for BaVariables.
         * Example: Options = new Map([[BaParameterId.ePresentValue, { appearance: { digits: 3 } }]]);
         */
        let Options: Map<BA.BaParameterId, IOptions>;
        class Error extends BaseError {
...
declare namespace TcHmi.BuildingAutomation.Charting {
    class Axis implements IDestroy {
        ...
        private __userOverridenOptions;
        /** True if the options of the axis have been overriden by the user. */
        get userOverridenOptions(): boolean;
        /**
         ...
         * @category Public
         */
        getFormatter(options?: Axis.IFormatterOptions): ((value: any) => string);
        /**
...
declare namespace TcHmi.BuildingAutomation.Charting {
    class Chart extends Components.Base implements Components.ResizeHandler.IOnResized {
        ...
        /**
         * Id for the timeout that will be awaited before echart gets updated.
         * @category Internal
         */
...
declare namespace TcHmi.BuildingAutomation.Charting {
    /** The size of the points which are displayed in a line chart. Default is 1. */
    let PointSymbolSize: number;
    /** The symbol of the points which are displayed in a line chart. Default is "circle". */
    let PointSymbol: 'circle' | 'rect' | 'roundRect' | 'triangle' | 'diamond' | 'pin' | 'arrow' | 'none';
...
declare namespace TcHmi.BuildingAutomation {
    namespace Charting {
        class Trend extends LineChart implements BaObjectHandler.IUsesBaObject {
            ...
            /**
             * The range in minutes of the x axes which is displayed.
             * 24 * 60 would display the last 24 hours.
             * @category Attribute
             */
            protected __xAxesRange: number | null | undefined;
            /**
             * The width of the series selector in %.
             * @category Attribute
             */
            protected __seriesSelectorWidth: number | null | undefined;
            /**
            ...
            /**
             * DestroyFunction for the watch if the BaTrends are updated automatically.
             * @category Internal
             */
            private __baTrendWatchDFs;
            /**
            ...
            /**
             * DestroyFunctions for the different description variables.
             * @category Internal
             */
            private __baDescriptionWatchDFs;
            /**
            ...
            /**
             * Getter for the XAxesRange attribute.
             * @category Attribute setter and getter
            ...
            /**
             * Getter for the SeriesSelectorWidth attribute.
             * @category Attribute setter and getter
...
declare namespace TcHmi.BuildingAutomation.Components {
    ...
    namespace ErrorIndicator {
        ...
        function isIErrorIndicator(p: any): p is IErrorIndicator;
        enum ErrorLevel {
            error = 0,
            connection = 1
        }
...
declare namespace TcHmi.BuildingAutomation.Components {
    class Calendar extends Base implements Components.ResizeHandler.IOnResized, BaObjectHandler.IUsesBaObject {
        ...
        */
        ...
        getUnit(): string | null | undefined;
        /**
         * Sets Digits attribute.
         * @category Attribute setter and getter
         * @param digits New Digits or NULL.
         */
        setDigits(digits: number | null | undefined): void;
        /**
         * Gets Digits attribute.
         * @category Attribute setter and getter
         * @returns Digits attribute.
         */
        getDigits(): number | null | undefined;
        /**
...
declare namespace TcHmi.BuildingAutomation.Components {
    ...
    */
    ...
    namespace InputBox {
        ...
        /** The default number of digits that is displayed, when DataType is number. Default is 1. */
        let DefaultDigits: number;
        /** The minimum number of digits that is displayed, when DataType is number. Default is 1. */
        let MinimumDigits: number;
    }
}
...
declare namespace TcHmi.BuildingAutomation.Components {
    ...
    class UiIcon extends Button implements BaObjectHandler.IUsesBaObject, Components.ResizeHandler.IOnResized {
        ...
        /**
         * The DestroyFunction for the watch of the Events property of the BaObject.
         * @category Internal
         */
        private __eventWatchDF;
        /**
        ...
        getDisplays(): Map<string, ValueField<ValueField.ValueType>> | undefined;
        /**
         ...
         */
        getDisplay(name: string): ValueField<ValueField.ValueType> | null;
        /**
         * Adds a display to the UiIcon.
         * @category Public
         * @param data The data for the display.
         */
        addDisplay(name: string, data: UiIcon.IDisplayData): ValueField<ValueField.ValueType>;
        /**
    ...
    namespace UiIcon {
         ...
         * @category UiIcon
         */
        interface IDisplayData extends ValueField.IAttributes<ValueField.ValueType> {
...
declare namespace TcHmi.BuildingAutomation.Components {
    ...
    class ValueField<T extends ValueField.ValueType> extends TextControl implements BaObjectHandler.IUsesBaObject {
        ...
        protected __onDataTypeChanged(): void;
        /**
         * Function to process the interaction on a component.
         * @category Event handler
         * @param e The EventProvider event.
         * @param component The component which raised the event.
         * @param event The event which will be raied.
         */
        private __processComponentInteraction;
        /**
        ...
        /**
         * Get the control for a given data type.
         * @param dataType The data type to get the control for.
         * @returns The control for the data type if it was created before or undefined if no control for the data type was created before.
         */
        private __getDataTypeControl;
        processBaObject(): void;
        /**
...
declare namespace TcHmi.BuildingAutomation.Components {
    class WeeklySchedule extends Base implements BaObjectHandler.IUsesBaObject {
        ...
        destroy(): void;
        /**
         * Updates the titles of the daily schedules.
         * @category Internal
         */
        private __updateDailyScheduleTitles;
        processBaObject(): void;
        /**
    ...
    namespace WeeklySchedule {
        interface IAttributes extends Base.IAttributes {
            ...
            unit?: string | null;
            /** Number of displayed digits in the entries. */
            digits?: number | null;
        }
...
declare namespace TcHmi {
    ...
    namespace BuildingAutomation.Helper {
        ...
        */
        ...
        /**
         * Checks if a {@link JsonSchema} implements a certain {@link JsonDataTypeNames}.
         * @param schema The {@link JsonSchema} to be checked.
         * @param type The {@link JsonDataTypeNames} to be checked.
         * @returns True is the {@link JsonSchema} implements the  {@link JsonDataTypeNames}, otherwise false.
         */
        function checkJsonSchemaType(schema: JsonSchema, type: JsonDataTypeNames): boolean;
    }
}
...
declare namespace TcHmi.BuildingAutomation {
    namespace Locale {
        ...
        enum LangKey {
            ...
            BaObjectNotResolved = "KeyL_BaObjectNotResolved",
            Cursor = "KeyL_Cursor",
            ...
            /** {0}: BaObjectInstancePath */
            BaViewWithNoTrends = "KeyL_BaViewWithNotTrends",
            /** {0}: BaObjectInstancePath */
            NotATrendObject = "KeyL_NotATrendObject",
            /** {0}: Control id */
            ...
            /** {0}: ExtensionName */
            ExtensionNotAvailable = "KeyL_ExtensionNotAvailable",
            /** {0}: ExtensionName, {1}: Seconds */
            ReloadPageAfterExtensionUnloaded = "KeyL_ReloadPageAfterExtensionUnloaded",
            /** {0}: ExtensionName */
...
declare namespace TcHmi.BuildingAutomation.Navigation {
    ...
    namespace ParameterList {
        ...
        class ParameterListEntry extends BaseList.BaseListEntry implements BaObjectHandler.IUsesBaObject {
            ...
            /**
             * The DestroyFunction of the current displayed BA description type.
             * @category Internal
             */
            private __baUsedTitleWatchDF;
            /**
             * Stores the DestroyFunction of the BaVariable if the passes data is a BaVariable.
             * @category Internal
             */
            private __baVarWatchValueDF;
            /**
             * Destroy function for the OnBaVariablesParameterInformationLoaded event.
             * @category Internal
             */
            ...
            /**
             * Destroy function for the onUserInteractionFinished event of the value field.
             * @category Internal
             */
            private __destroyOnValueFieldUserInteractionFinished;
            /**
        ...
        namespace ParameterListEntry {
            ...
            enum ParameterListEntryEvents {
                ...
                onValueChanged = "onValueChanged",
                /** Is fired when the user interfaction on the value field in the entry has finished. */
                onUserInteractionFinished = "onUserInteractionFinished"
            }
        }
    }
...
declare namespace TcHmi.BuildingAutomation.Server.BaSite {
    /** (ReadOnly) Indicates if the extension is loaded from the server. */
    export let extensionLoaded: boolean;
    /** (ReadOnly) Indicates if the {@link BA.BaDevice}s were loaded. */
    export let devicesLoaded: boolean;
    /** (ReadOnly) Indicates that the BaSite is ready and all required data was loaded from the server. */
    ...
    export enum Events {
        /** Is raised when the extension is loaded from the server. */
        ...
        /** Is raised when the available symbols of the extension have changed. */
        onExtensionAvailableSymbolsChanged = "BaSite.onExtensionAvailableSymbolsChanged",
        ...
        /** Is raised when the project structure of a device was laoded. */
        onDeviceProjectStructureLoaded = "BaSite.onDeviceProjectStructureLoaded",
        /** Is raised when the project structures of all connected devices are loaded. */
        onAllDeviceProjectStructuresLoaded = "BaSite.onAllDeviceProjectStructuresLoaded",
        /** Is raised when the BaSite and all devices are loaded. */
        onReady = "BaSite.onReady"
    }
     ...
     * @category Utilities
     */
    export function updateBaStandardParameterInformationAsync(): Promise<void>;
    /**
     * Updates Globals.BaAdditionalParameterInformation.
     * @category Utilities
     */
    export function updateBaAdditionalParameterInformationAsync(): Promise<void>;
    /**
     * Updates Globals.Units.
     * @category Utilities
     */
    export function updateUnitsAsync(): Promise<void>;
    /**
...
declare namespace TcHmi.BuildingAutomation.Server {
    ...
    class SubscriptionCollector implements Logger.ILogger {
        /**
...
declare namespace TcHmi.BuildingAutomation.System {
    class ValueHandler<T> implements IDestroy, Logger.ILogger {
        ...
        /**
         * The owner of the ValueHandler.
         * @category Internal
         */
        private __owner;
        /**
         * The mapping name of the value.
         * @category Internal
         */
        private __valueMapping;
        /**
         * Stores the DestroyFunction for the value subscription.
         * @category Internal
         */
        private __valueSubscriptionDF;
        /**
         * Stores the DestroyFunction of the BaVariable if the passes data is a BaVariable.
         * @category Internal
         */
        private __baVarWatchDF;
        /**
...
declare namespace TcHmi.BuildingAutomation {
    namespace Globals {
        ...
        namespace Keyboard {
            let Layout: Globals.Locale.KBLayout;
